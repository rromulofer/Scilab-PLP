...
T1 = uicontrol(h, 'style', 'text',...
                  'string', 'DIGITE O MÊS QUE DESEJA SE CONSULTAR: ', ...
                  'position', [20 500 250 50], ...
                  'backgroundcolor', [0.9 0.9 0.9]);
E1 = uicontrol(h, 'style', 'edit', ...
                  'string', '01', ...
                  'position', [240 510 30 30], ...
                  'fontsize', 15, ...
...
//dia
T3 = uicontrol(h, 'style', 'text', 'string', 'DIGITE O DIA DO MÊS QUE DESEJA SE CONSULTAR:', ..
'position', [20 160 300 50], 'backgroundcolor', [0.9 0.9 0.9]);

E3 = uicontrol(h, 'style', 'edit', 'string', '01', ..
'position', [280 170 30 30], 'fontsize', 15, 'backgroundcolor', [1 1 1]);


messagebox('CONSULTA MARCADA: '+E1, Aluno)
